...
const protectedRoutes = ['/room' , '/profile' , '/wishlist' , '/post-room', '/chat' , '/chat/[id]']
...
export const config = {
  matcher: ['/room', '/auth/user/register', '/auth/user/login' , '/profile' , '/wishlist' , '/post-room' , '/chat' , '/chat/[id]'],
}