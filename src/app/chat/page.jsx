...
export default function ChatConnectionsPage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 md:p-5">
      <div className="w-full max-w-md bg-white p-4 shadow-lg rounded-lg h-screen ">
        <Link href="/room">
          <ArrowLeft className="h-10 w-10 absolute shadow-lg rounded-full p-2" />
        </Link>
